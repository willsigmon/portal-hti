    ...
    <nav className="sticky top-0 z-50 border-b border-[var(--color-border)] bg-[color-mix(in_oklch,var(--color-bg)_86%,transparent)] backdrop-blur-xl">
      <div className="container flex h-20 items-center justify-between gap-4">
        <Link href="/portal-hq" className="group flex items-center gap-3" aria-label="The Portal HQ home">
          <span className="grid h-11 w-11 place-items-center rounded-sm border border-[var(--color-border)] bg-[var(--color-panel)]/85 shadow-sm transition-transform group-hover:-rotate-2">
        ...
        <div className="hidden items-center gap-1 rounded-sm border border-[var(--color-border)] bg-[var(--color-panel)]/72 p-1 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] backdrop-blur-md md:flex">
          {tabs.map((tab) => (
